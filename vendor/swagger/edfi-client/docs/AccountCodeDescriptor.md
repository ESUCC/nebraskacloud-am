...
**account_code_category** | **string** | The type of the account code (e.g., fund, function, object) | 
**account_code_descriptor_id** | **int** | The ID of the AccountCodeDescriptor | [optional] 
**begin_date** | [**\DateTime**](\DateTime.md) | The first date the account code is valid. | [optional] 
...
**end_date** | [**\DateTime**](\DateTime.md) | The last date the account code is valid. | [optional] 
