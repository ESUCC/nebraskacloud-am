# PostGraduateActivityDeterminationDescriptor
...
**post_graduate_activity_determination_descriptor_id** | **int** | The ID of the PostGraduate Activity Determination Descriptor. | [optional] 
