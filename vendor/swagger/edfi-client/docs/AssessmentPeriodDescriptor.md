...
**assessment_period_descriptor_id** | **int** | The ID of the Assessment Period Descriptor | [optional] 
**begin_date** | [**\DateTime**](\DateTime.md) | The first date the assessment is to be administered. | [optional] 
...
**end_date** | [**\DateTime**](\DateTime.md) | The last date the assessment is to be administered. | [optional] 
