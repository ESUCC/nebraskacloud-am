# ParaprofessionalAssessmentPassedDescriptor
...
**paraprofessional_assessment_passed_descriptor_id** | **int** | The ID of the Paraprofessional Assessment Passed Descriptor. | [optional] 
