...
**school_food_services_eligibility_descriptor_id** | **int** | A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table. | [optional] 
**school_food_services_eligibility_type** | **string** | Key for SchoolFoodServicesEligibility | [optional] 
