...
**grade_levels** | [**\Swagger\Client\Model\LevelDescriptorGradeLevel[]**](LevelDescriptorGradeLevel.md) | An unordered collection of levelDescriptorGradeLevels.  This descriptor defines the grade level(s) certified for teaching. | [optional] 
**id** | **string** | The unique identifier of the resource. | 
**level_descriptor_id** | **int** | A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table. | [optional] 
