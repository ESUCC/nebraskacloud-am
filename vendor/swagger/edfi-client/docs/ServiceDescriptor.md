...
**service_category** | **string** | A classification of the behavior for reporting types. | [optional] 
**service_descriptor_id** | **int** | The ID of the Service Descriptor | [optional] 
