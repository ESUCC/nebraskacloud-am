...
**performance_base_conversion_type** | **string** | A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table. | [optional] 
**performance_level_descriptor_id** | **int** | The ID of the Performance Level Descriptor | [optional] 
