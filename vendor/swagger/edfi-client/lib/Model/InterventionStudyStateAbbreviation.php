...
use \ArrayAccess;
/**
 * InterventionStudyStateAbbreviation Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InterventionStudyStateAbbreviation implements ArrayAccess
{
    /**
    ...
    /**
      * $state_abbreviation_type Key for StateAbbreviationType
      * @var string
      */
     ...
     * @param string $state_abbreviation_type Key for StateAbbreviationType
     * @return $this
     */
