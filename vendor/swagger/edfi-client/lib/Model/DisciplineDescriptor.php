...
use \ArrayAccess;
/**
 * DisciplineDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DisciplineDescriptor implements ArrayAccess
{
    /**
    ...
    static $setters = array(
        ...
        'discipline_type' => 'setDisciplineType',
    ...
    /**
      * $discipline_descriptor_id The ID of the Discipline Descriptor
      * @var int
      */
    protected $discipline_descriptor_id;
    
    /**
      * $discipline_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var string
      */
    protected $discipline_type;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->discipline_descriptor_id = $data["discipline_descriptor_id"];
            $this->discipline_type = $data["discipline_type"];
    ...
    {
        return $this->discipline_descriptor_id;
    }
  
    /**
     * Sets discipline_descriptor_id
     * @param int $discipline_descriptor_id The ID of the Discipline Descriptor
     * @return $this
     */
    public function setDisciplineDescriptorId($discipline_descriptor_id)
    {
        
        $this->discipline_descriptor_id = $discipline_descriptor_id;
        return $this;
    }
    
    /**
     * Gets discipline_type
     * @return string
     */
    ...
    /**
     * Sets discipline_type
     * @param string $discipline_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setDisciplineType($discipline_type)
    {
