...
use \ArrayAccess;
/**
 * SectionCharacteristicDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SectionCharacteristicDescriptor implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'section_characteristic_type' => 'string',
    ...
    static $attributeMap = array(
        ...
        'section_characteristic_type' => 'sectionCharacteristicType',
    ...
    static $setters = array(
        ...
        'section_characteristic_type' => 'setSectionCharacteristicType',
    ...
    static $getters = array(
        ...
        'section_characteristic_type' => 'getSectionCharacteristicType',
    ...
    /**
      * $section_characteristic_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $section_characteristic_descriptor_id;
    
    /**
      * $section_characteristic_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var string
      */
    protected $section_characteristic_type;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->section_characteristic_descriptor_id = $data["section_characteristic_descriptor_id"];
            $this->section_characteristic_type = $data["section_characteristic_type"];
    ...
    {
        return $this->section_characteristic_descriptor_id;
    }
  
    /**
     * Sets section_characteristic_descriptor_id
     * @param int $section_characteristic_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setSectionCharacteristicDescriptorId($section_characteristic_descriptor_id)
    {
        
        $this->section_characteristic_descriptor_id = $section_characteristic_descriptor_id;
        return $this;
    }
    
    /**
     * Gets section_characteristic_type
     * @return string
     */
    public function getSectionCharacteristicType()
    {
        return $this->section_characteristic_type;
    }
  
    /**
     * Sets section_characteristic_type
     * @param string $section_characteristic_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setSectionCharacteristicType($section_characteristic_type)
    {
        
        $this->section_characteristic_type = $section_characteristic_type;
        return $this;
    }
