...
use \ArrayAccess;
/**
 * SessionReference Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SessionReference implements ArrayAccess
{
    /**
    ...
    /**
      * $school_year The identifier for the school year (e.g., 2010/11).
      * @var int
      */
    ...
    /**
      * $link Represents a hyperlink to the related session resource.
    ...
    /**
     * Sets school_year
     * @param int $school_year The identifier for the school year (e.g., 2010/11).
     * @return $this
     */
    ...
    /**
     * Sets link
     * @param \Swagger\Client\Model\Link $link Represents a hyperlink to the related session resource.
     * @return $this
     */
