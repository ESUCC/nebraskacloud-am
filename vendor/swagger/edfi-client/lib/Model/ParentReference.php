...
use \ArrayAccess;
/**
 * ParentReference Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ParentReference implements ArrayAccess
{
    /**
    ...
    /**
      * $parent_unique_id A unique alpha-numeric code assigned to a parent.
      * @var string
      */
    protected $parent_unique_id;
    
    /**
      * $link Represents a hyperlink to the related parent resource.
     ...
     * @param string $parent_unique_id A unique alpha-numeric code assigned to a parent.
     * @return $this
     */
    ...
    /**
     * Sets link
     * @param \Swagger\Client\Model\Link $link Represents a hyperlink to the related parent resource.
     * @return $this
     */
