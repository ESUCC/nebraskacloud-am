...
use \ArrayAccess;
/**
 * ServiceDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ServiceDescriptor implements ArrayAccess
{
    /**
    ...
    /**
      * $service_category A classification of the behavior for reporting types.
      * @var string
      */
    protected $service_category;
    
    /**
      * $service_descriptor_id The ID of the Service Descriptor
      * @var int
      */
    protected $service_descriptor_id;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->service_descriptor_id = $data["service_descriptor_id"];
     ...
     * @param string $service_category A classification of the behavior for reporting types.
     * @return $this
     */
    ...
    {
        return $this->service_descriptor_id;
    }
  
    /**
     * Sets service_descriptor_id
     * @param int $service_descriptor_id The ID of the Service Descriptor
     * @return $this
     */
