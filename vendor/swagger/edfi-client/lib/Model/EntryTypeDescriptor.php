...
use \ArrayAccess;
/**
 * EntryTypeDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EntryTypeDescriptor implements ArrayAccess
{
    /**
    ...
    /**
      * $entry_type Key for Entry
      * @var string
      */
    protected $entry_type;
    
    /**
      * $entry_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $entry_type_descriptor_id;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->entry_type_descriptor_id = $data["entry_type_descriptor_id"];
            $this->id = $data["id"];
    ...
    /**
     * Sets entry_type
     * @param string $entry_type Key for Entry
     * @return $this
     */
    ...
    {
        return $this->entry_type_descriptor_id;
    }
  
    /**
     * Sets entry_type_descriptor_id
     * @param int $entry_type_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setEntryTypeDescriptorId($entry_type_descriptor_id)
    {
        
        $this->entry_type_descriptor_id = $entry_type_descriptor_id;
        return $this;
    }
