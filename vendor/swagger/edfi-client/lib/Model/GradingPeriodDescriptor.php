...
use \ArrayAccess;
/**
 * GradingPeriodDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GradingPeriodDescriptor implements ArrayAccess
{
    /**
    ...
    static $setters = array(
        ...
        'grading_period_type' => 'setGradingPeriodType',
        'id' => 'setId',
    ...
    static $getters = array(
        ...
        'grading_period_type' => 'getGradingPeriodType',
        'id' => 'getId',
    ...
    /**
      * $grading_period_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $grading_period_descriptor_id;
    
    /**
      * $grading_period_type Key for GradingPeriod
      * @var string
      */
    protected $grading_period_type;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->grading_period_descriptor_id = $data["grading_period_descriptor_id"];
            $this->grading_period_type = $data["grading_period_type"];
            $this->id = $data["id"];
    ...
    {
        return $this->grading_period_descriptor_id;
    }
  
    /**
     * Sets grading_period_descriptor_id
     * @param int $grading_period_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setGradingPeriodDescriptorId($grading_period_descriptor_id)
    {
        
        $this->grading_period_descriptor_id = $grading_period_descriptor_id;
        return $this;
    }
    
    /**
     * Gets grading_period_type
     * @return string
     */
    public function getGradingPeriodType()
    {
        return $this->grading_period_type;
    }
  
    /**
     * Sets grading_period_type
     * @param string $grading_period_type Key for GradingPeriod
     * @return $this
     */
    public function setGradingPeriodType($grading_period_type)
    {
        
        $this->grading_period_type = $grading_period_type;
        return $this;
    }
