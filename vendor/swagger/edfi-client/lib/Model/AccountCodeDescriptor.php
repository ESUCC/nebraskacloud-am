...
use \ArrayAccess;
/**
 * AccountCodeDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AccountCodeDescriptor implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        '_etag' => 'string',
        'account_code_category' => 'string',
        'account_code_descriptor_id' => 'int',
        'begin_date' => '\DateTime',
        'code_value' => 'string',
        'description' => 'string',
    ...
    static $attributeMap = array(
        '_etag' => '_etag',
        'account_code_category' => 'accountCodeCategory',
        'account_code_descriptor_id' => 'accountCodeDescriptorId',
    ...
    static $setters = array(
        '_etag' => 'setEtag',
        'account_code_category' => 'setAccountCodeCategory',
        'account_code_descriptor_id' => 'setAccountCodeDescriptorId',
    ...
    static $getters = array(
        '_etag' => 'getEtag',
        'account_code_category' => 'getAccountCodeCategory',
        'account_code_descriptor_id' => 'getAccountCodeDescriptorId',
    ...
    /**
      * $account_code_category The type of the account code (e.g., fund, function, object)
      * @var string
      */
    protected $account_code_category;
    
    /**
      * $account_code_descriptor_id The ID of the AccountCodeDescriptor
      * @var int
      */
    protected $account_code_descriptor_id;
    
    /**
      * $begin_date The first date the account code is valid.
      * @var \DateTime
      */
    ...
    /**
      * $end_date The last date the account code is valid.
      * @var \DateTime
      */
    protected $end_date;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->account_code_category = $data["account_code_category"];
            $this->account_code_descriptor_id = $data["account_code_descriptor_id"];
    ...
    /**
     * Gets account_code_category
     * @return string
     */
    public function getAccountCodeCategory()
    {
        return $this->account_code_category;
    }
  
    /**
     * Sets account_code_category
     * @param string $account_code_category The type of the account code (e.g., fund, function, object)
     * @return $this
     */
    public function setAccountCodeCategory($account_code_category)
    {
        
        $this->account_code_category = $account_code_category;
        return $this;
    }
    
    /**
     * Gets account_code_descriptor_id
     * @return int
     */
    public function getAccountCodeDescriptorId()
    {
        return $this->account_code_descriptor_id;
    }
  
    /**
     * Sets account_code_descriptor_id
     * @param int $account_code_descriptor_id The ID of the AccountCodeDescriptor
     * @return $this
     */
    public function setAccountCodeDescriptorId($account_code_descriptor_id)
    {
        
        $this->account_code_descriptor_id = $account_code_descriptor_id;
        return $this;
    }
    ...
    /**
     * Sets begin_date
     * @param \DateTime $begin_date The first date the account code is valid.
     * @return $this
     */
    ...
    /**
     * Sets end_date
     * @param \DateTime $end_date The last date the account code is valid.
     * @return $this
     */
