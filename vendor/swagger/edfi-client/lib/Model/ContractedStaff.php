...
use \ArrayAccess;
/**
 * ContractedStaff Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContractedStaff implements ArrayAccess
{
    /**
    ...
    /**
      * $as_of_date The date of the reported contracted staff element.
      * @var \\DateTime
      */
    protected $as_of_date;
    
    /**
      * $amount_to_date Current balance (amount paid to contractor) for account for the fiscal year.
      * @var Number
      */
    ...
    /**
     * Sets as_of_date
     * @param \\DateTime $as_of_date The date of the reported contracted staff element.
     * @return $this
     */
    ...
    /**
     * Sets amount_to_date
     * @param Number $amount_to_date Current balance (amount paid to contractor) for account for the fiscal year.
     * @return $this
     */
