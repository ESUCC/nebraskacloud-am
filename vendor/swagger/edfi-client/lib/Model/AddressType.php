 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AddressType implements ArrayAccess
{
    /**
    ...
    /**
      * $address_type_id Key for Address
      * @var int
      */
    protected $address_type_id;
    
    /**
      * $code_value Code for Address type.
      * @var string
      */
     ...
     * @param int $address_type_id Key for Address
     * @return $this
     */
    ...
    /**
     * Sets code_value
     * @param string $code_value Code for Address type.
     * @return $this
     */
