...
use \ArrayAccess;
/**
 * EducationServiceCenter Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EducationServiceCenter implements ArrayAccess
{
    /**
    ...
    /**
      * $education_service_center_id The identifier assigned to an education service center by the State Education Agency (SEA).
      * @var int
      */
    protected $education_service_center_id;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->education_service_center_id = $data["education_service_center_id"];
    ...
    {
        return $this->education_service_center_id;
    }
  
    /**
     * Sets education_service_center_id
     * @param int $education_service_center_id The identifier assigned to an education service center by the State Education Agency (SEA).
     * @return $this
     */
    public function setEducationServiceCenterId($education_service_center_id)
    {
        
        $this->education_service_center_id = $education_service_center_id;
        return $this;
    }
