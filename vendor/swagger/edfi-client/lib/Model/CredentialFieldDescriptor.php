...
use \ArrayAccess;
/**
 * CredentialFieldDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CredentialFieldDescriptor implements ArrayAccess
{
    /**
    ...
    /**
      * $credential_field_descriptor_id The ID of the Credential Field Descriptor
      * @var int
      */
    protected $credential_field_descriptor_id;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->credential_field_descriptor_id = $data["credential_field_descriptor_id"];
     ...
     * @param string $academic_subject_descriptor 
     * @return $this
     */
    ...
    {
        return $this->credential_field_descriptor_id;
    }
  
    /**
     * Sets credential_field_descriptor_id
     * @param int $credential_field_descriptor_id The ID of the Credential Field Descriptor
     * @return $this
     */
    public function setCredentialFieldDescriptorId($credential_field_descriptor_id)
    {
        
        $this->credential_field_descriptor_id = $credential_field_descriptor_id;
        return $this;
    }
