...
use \ArrayAccess;
/**
 * DiagnosisDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DiagnosisDescriptor implements ArrayAccess
{
    /**
    ...
    /**
      * $diagnosis_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $diagnosis_descriptor_id;
    
    /**
      * $diagnosis_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var string
      */
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->diagnosis_descriptor_id = $data["diagnosis_descriptor_id"];
    ...
    {
        return $this->diagnosis_descriptor_id;
    }
  
    /**
     * Sets diagnosis_descriptor_id
     * @param int $diagnosis_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setDiagnosisDescriptorId($diagnosis_descriptor_id)
    {
        
        $this->diagnosis_descriptor_id = $diagnosis_descriptor_id;
        return $this;
    }
    ...
    /**
     * Sets diagnosis_type
     * @param string $diagnosis_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
