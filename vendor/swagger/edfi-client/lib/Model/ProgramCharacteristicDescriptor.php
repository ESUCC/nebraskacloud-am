...
use \ArrayAccess;
/**
 * ProgramCharacteristicDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProgramCharacteristicDescriptor implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'program_characteristic_type' => 'string',
    ...
    static $attributeMap = array(
        ...
        'program_characteristic_type' => 'programCharacteristicType',
    ...
    static $setters = array(
        ...
        'program_characteristic_type' => 'setProgramCharacteristicType',
    ...
    static $getters = array(
        ...
        'program_characteristic_type' => 'getProgramCharacteristicType',
    ...
    /**
      * $program_characteristic_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $program_characteristic_descriptor_id;
    
    /**
      * $program_characteristic_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var string
      */
    protected $program_characteristic_type;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->program_characteristic_descriptor_id = $data["program_characteristic_descriptor_id"];
            $this->program_characteristic_type = $data["program_characteristic_type"];
    ...
    {
        return $this->program_characteristic_descriptor_id;
    }
  
    /**
     * Sets program_characteristic_descriptor_id
     * @param int $program_characteristic_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setProgramCharacteristicDescriptorId($program_characteristic_descriptor_id)
    {
        
        $this->program_characteristic_descriptor_id = $program_characteristic_descriptor_id;
        return $this;
    }
    
    /**
     * Gets program_characteristic_type
     * @return string
     */
    public function getProgramCharacteristicType()
    {
        return $this->program_characteristic_type;
    }
  
    /**
     * Sets program_characteristic_type
     * @param string $program_characteristic_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setProgramCharacteristicType($program_characteristic_type)
    {
        
        $this->program_characteristic_type = $program_characteristic_type;
        return $this;
    }
