...
use \ArrayAccess;
/**
 * GraduationPlanRequiredAssessmentAssessmentPerformanceLevel Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class GraduationPlanRequiredAssessmentAssessmentPerformanceLevel implements ArrayAccess
{
    /**
    ...
    /**
      * $performance_level_descriptor The performance level(s) defined for the assessment.
      * @var string
      */
    protected $performance_level_descriptor;
    
    /**
      * $assessment_reporting_method_type The method that the instructor of the class uses to report the performance and achievement of all students. It may be a qualitative method such as individualized teacher comments or a quantitative method such as a letter or numerical grade. In some cases, more than one type of reporting method may be used.
      * @var string
      */
    ...
    /**
      * $result_datatype_type The datatype of the result. The results can be expressed as a number, percentile, range, level, etc.
      * @var string
      */
     ...
     * @param string $assessment_reporting_method_type The method that the instructor of the class uses to report the performance and achievement of all students. It may be a qualitative method such as individualized teacher comments or a quantitative method such as a letter or numerical grade. In some cases, more than one type of reporting method may be used.
     * @return $this
     */
     ...
     * @param string $result_datatype_type The datatype of the result. The results can be expressed as a number, percentile, range, level, etc.
     * @return $this
     */
