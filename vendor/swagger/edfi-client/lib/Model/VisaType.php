 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class VisaType implements ArrayAccess
{
    /**
    ...
    /**
      * $visa_type_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    ...
    /**
     * Sets visa_type_id
     * @param int $visa_type_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
