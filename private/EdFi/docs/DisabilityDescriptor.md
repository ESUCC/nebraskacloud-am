...
**disability_category_type** | **string** | A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table. | 
...
**disability_type** | **string** | Key for Disability | [optional] 
