...
**discipline_descriptor_id** | **int** | The ID of the Discipline Descriptor | [optional] 
**discipline_type** | **string** | A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table. | [optional] 
