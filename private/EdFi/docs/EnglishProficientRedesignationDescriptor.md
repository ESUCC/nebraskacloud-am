# EnglishProficientRedesignationDescriptor
...
**english_proficient_redesignation_descriptor_id** | **int** | The ID of the English Proficient Redesignation Descriptor. | [optional] 
