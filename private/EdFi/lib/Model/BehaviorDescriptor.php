...
use \ArrayAccess;
/**
 * BehaviorDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BehaviorDescriptor implements ArrayAccess
{
    /**
    ...
    /**
      * $behavior_descriptor_id The ID of the Behavior Descriptor
      * @var int
      */
    protected $behavior_descriptor_id;
    
    /**
      * $behavior_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var string
      */
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->behavior_descriptor_id = $data["behavior_descriptor_id"];
    ...
    {
        return $this->behavior_descriptor_id;
    }
  
    /**
     * Sets behavior_descriptor_id
     * @param int $behavior_descriptor_id The ID of the Behavior Descriptor
     * @return $this
     */
    public function setBehaviorDescriptorId($behavior_descriptor_id)
    {
        
        $this->behavior_descriptor_id = $behavior_descriptor_id;
        return $this;
    }
    ...
    /**
     * Sets behavior_type
     * @param string $behavior_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
