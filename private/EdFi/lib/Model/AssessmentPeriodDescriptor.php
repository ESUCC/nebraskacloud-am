...
use \ArrayAccess;
/**
 * AssessmentPeriodDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AssessmentPeriodDescriptor implements ArrayAccess
{
    /**
    ...
    /**
      * $assessment_period_descriptor_id The ID of the Assessment Period Descriptor
      * @var int
      */
    protected $assessment_period_descriptor_id;
    
    /**
      * $begin_date The first date the assessment is to be administered.
      * @var \DateTime
      */
    ...
    /**
      * $end_date The last date the assessment is to be administered.
      * @var \DateTime
      */
    protected $end_date;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->assessment_period_descriptor_id = $data["assessment_period_descriptor_id"];
    ...
    {
        return $this->assessment_period_descriptor_id;
    }
  
    /**
     * Sets assessment_period_descriptor_id
     * @param int $assessment_period_descriptor_id The ID of the Assessment Period Descriptor
     * @return $this
     */
    public function setAssessmentPeriodDescriptorId($assessment_period_descriptor_id)
    {
        
        $this->assessment_period_descriptor_id = $assessment_period_descriptor_id;
        return $this;
    }
    ...
    /**
     * Sets begin_date
     * @param \DateTime $begin_date The first date the assessment is to be administered.
     * @return $this
     */
    ...
    /**
     * Sets end_date
     * @param \DateTime $end_date The last date the assessment is to be administered.
     * @return $this
     */
