...
use \ArrayAccess;
/**
 * WeaponDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class WeaponDescriptor implements ArrayAccess
{
    /**
    ...
    /**
      * $weapon_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $weapon_descriptor_id;
    
    /**
      * $weapon_type Key for Weapons
      * @var string
      */
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->weapon_descriptor_id = $data["weapon_descriptor_id"];
    ...
    {
        return $this->weapon_descriptor_id;
    }
  
    /**
     * Sets weapon_descriptor_id
     * @param int $weapon_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setWeaponDescriptorId($weapon_descriptor_id)
    {
        
        $this->weapon_descriptor_id = $weapon_descriptor_id;
        return $this;
    }
    ...
    /**
     * Sets weapon_type
     * @param string $weapon_type Key for Weapons
     * @return $this
     */
