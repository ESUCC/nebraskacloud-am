...
use \ArrayAccess;
/**
 * AccommodationDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AccommodationDescriptor implements ArrayAccess
{
    /**
    ...
    /**
      * $accommodation_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $accommodation_descriptor_id;
    
    /**
      * $accommodation_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var string
      */
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->accommodation_descriptor_id = $data["accommodation_descriptor_id"];
            $this->accommodation_type = $data["accommodation_type"];
    ...
    {
        return $this->accommodation_descriptor_id;
    }
  
    /**
     * Sets accommodation_descriptor_id
     * @param int $accommodation_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setAccommodationDescriptorId($accommodation_descriptor_id)
    {
        
        $this->accommodation_descriptor_id = $accommodation_descriptor_id;
        return $this;
    }
     ...
     * @param string $accommodation_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
