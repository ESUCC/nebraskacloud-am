...
use \ArrayAccess;
/**
 * SchoolFoodServicesEligibilityDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SchoolFoodServicesEligibilityDescriptor implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'school_food_services_eligibility_descriptor_id' => 'int',
        'school_food_services_eligibility_type' => 'string',
    ...
    static $attributeMap = array(
        ...
        'school_food_services_eligibility_descriptor_id' => 'schoolFoodServicesEligibilityDescriptorId',
        'school_food_services_eligibility_type' => 'schoolFoodServicesEligibilityType',
    ...
    static $setters = array(
        ...
        'school_food_services_eligibility_descriptor_id' => 'setSchoolFoodServicesEligibilityDescriptorId',
        'school_food_services_eligibility_type' => 'setSchoolFoodServicesEligibilityType',
    ...
    static $getters = array(
        ...
        'school_food_services_eligibility_descriptor_id' => 'getSchoolFoodServicesEligibilityDescriptorId',
        'school_food_services_eligibility_type' => 'getSchoolFoodServicesEligibilityType',
    ...
    /**
      * $school_food_services_eligibility_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $school_food_services_eligibility_descriptor_id;
    
    /**
      * $school_food_services_eligibility_type Key for SchoolFoodServicesEligibility
      * @var string
      */
    protected $school_food_services_eligibility_type;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->school_food_services_eligibility_descriptor_id = $data["school_food_services_eligibility_descriptor_id"];
            $this->school_food_services_eligibility_type = $data["school_food_services_eligibility_type"];
    ...
    /**
     * Gets school_food_services_eligibility_descriptor_id
     * @return int
     */
    public function getSchoolFoodServicesEligibilityDescriptorId()
    {
        return $this->school_food_services_eligibility_descriptor_id;
    }
  
    /**
     * Sets school_food_services_eligibility_descriptor_id
     * @param int $school_food_services_eligibility_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setSchoolFoodServicesEligibilityDescriptorId($school_food_services_eligibility_descriptor_id)
    {
        
        $this->school_food_services_eligibility_descriptor_id = $school_food_services_eligibility_descriptor_id;
        return $this;
    }
    
    /**
     * Gets school_food_services_eligibility_type
     * @return string
     */
    public function getSchoolFoodServicesEligibilityType()
    {
        return $this->school_food_services_eligibility_type;
    }
  
    /**
     * Sets school_food_services_eligibility_type
     * @param string $school_food_services_eligibility_type Key for SchoolFoodServicesEligibility
     * @return $this
     */
    public function setSchoolFoodServicesEligibilityType($school_food_services_eligibility_type)
    {
        
        $this->school_food_services_eligibility_type = $school_food_services_eligibility_type;
        return $this;
    }
