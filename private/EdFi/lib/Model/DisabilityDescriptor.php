...
use \ArrayAccess;
/**
 * DisabilityDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DisabilityDescriptor implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'code_value' => 'string',
        'description' => 'string',
        'disability_category_type' => 'string',
    ...
    static $attributeMap = array(
        ...
        'disability_category_type' => 'disabilityCategoryType',
    ...
    static $setters = array(
        ...
        'disability_category_type' => 'setDisabilityCategoryType',
        'disability_descriptor_id' => 'setDisabilityDescriptorId',
        'disability_type' => 'setDisabilityType',
    ...
    static $getters = array(
        ...
        'disability_category_type' => 'getDisabilityCategoryType',
        'disability_descriptor_id' => 'getDisabilityDescriptorId',
        'disability_type' => 'getDisabilityType',
    ...
    /**
      * $disability_category_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var string
      */
    protected $disability_category_type;
    
    /**
      * $disability_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $disability_descriptor_id;
    
    /**
      * $disability_type Key for Disability
      * @var string
      */
    protected $disability_type;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->disability_category_type = $data["disability_category_type"];
            $this->disability_descriptor_id = $data["disability_descriptor_id"];
    ...
    /**
     * Gets disability_category_type
     * @return string
     */
    public function getDisabilityCategoryType()
    {
        return $this->disability_category_type;
    }
  
    /**
     * Sets disability_category_type
     * @param string $disability_category_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setDisabilityCategoryType($disability_category_type)
    {
        
        $this->disability_category_type = $disability_category_type;
        return $this;
    }
    ...
    {
        return $this->disability_descriptor_id;
    }
  
    /**
     * Sets disability_descriptor_id
     * @param int $disability_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setDisabilityDescriptorId($disability_descriptor_id)
    {
        
        $this->disability_descriptor_id = $disability_descriptor_id;
        return $this;
    }
    
    /**
     * Gets disability_type
     * @return string
     */
    ...
    /**
     * Sets disability_type
     * @param string $disability_type Key for Disability
     * @return $this
     */
