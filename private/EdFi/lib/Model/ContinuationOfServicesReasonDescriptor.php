...
use \ArrayAccess;
/**
 * ContinuationOfServicesReasonDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ContinuationOfServicesReasonDescriptor implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'continuation_of_services_reason_type' => 'string',
        'description' => 'string',
    ...
    static $attributeMap = array(
        ...
        'continuation_of_services_reason_type' => 'continuationOfServicesReasonType',
    ...
    static $setters = array(
        ...
        'continuation_of_services_reason_type' => 'setContinuationOfServicesReasonType',
    ...
    static $getters = array(
        ...
        'continuation_of_services_reason_type' => 'getContinuationOfServicesReasonType',
    ...
    /**
      * $continuation_of_services_reason_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $continuation_of_services_reason_descriptor_id;
    
    /**
      * $continuation_of_services_reason_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var string
      */
    protected $continuation_of_services_reason_type;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->continuation_of_services_reason_descriptor_id = $data["continuation_of_services_reason_descriptor_id"];
            $this->continuation_of_services_reason_type = $data["continuation_of_services_reason_type"];
    ...
    {
        return $this->continuation_of_services_reason_descriptor_id;
    }
  
    /**
     * Sets continuation_of_services_reason_descriptor_id
     * @param int $continuation_of_services_reason_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setContinuationOfServicesReasonDescriptorId($continuation_of_services_reason_descriptor_id)
    {
        
        $this->continuation_of_services_reason_descriptor_id = $continuation_of_services_reason_descriptor_id;
        return $this;
    }
    
    /**
     * Gets continuation_of_services_reason_type
     * @return string
     */
    public function getContinuationOfServicesReasonType()
    {
        return $this->continuation_of_services_reason_type;
    }
  
    /**
     * Sets continuation_of_services_reason_type
     * @param string $continuation_of_services_reason_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setContinuationOfServicesReasonType($continuation_of_services_reason_type)
    {
        
        $this->continuation_of_services_reason_type = $continuation_of_services_reason_type;
        return $this;
    }
