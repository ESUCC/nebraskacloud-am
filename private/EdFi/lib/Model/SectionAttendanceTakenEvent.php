...
use \ArrayAccess;
/**
 * SectionAttendanceTakenEvent Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SectionAttendanceTakenEvent implements ArrayAccess
{
    /**
    ...
    /**
      * $event_date The date the SectionAttendanceTakenEvent was submitted, which could be a different date than the instructional day.
      * @var \\DateTime
      */
    ...
    /**
     * Sets event_date
     * @param \\DateTime $event_date The date the SectionAttendanceTakenEvent was submitted, which could be a different date than the instructional day.
     * @return $this
     */
