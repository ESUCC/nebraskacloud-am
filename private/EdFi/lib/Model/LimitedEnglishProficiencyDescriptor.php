...
use \ArrayAccess;
/**
 * LimitedEnglishProficiencyDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LimitedEnglishProficiencyDescriptor implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'limited_english_proficiency_type' => 'string',
        'namespace' => 'string',
    ...
    static $attributeMap = array(
        ...
        'limited_english_proficiency_type' => 'limitedEnglishProficiencyType',
        'namespace' => 'namespace',
    ...
    static $setters = array(
        ...
        'limited_english_proficiency_type' => 'setLimitedEnglishProficiencyType',
    ...
    static $getters = array(
        ...
        'limited_english_proficiency_type' => 'getLimitedEnglishProficiencyType',
    ...
    /**
      * $limited_english_proficiency_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $limited_english_proficiency_descriptor_id;
    
    /**
      * $limited_english_proficiency_type Key for LimitedEnglishProficiency
      * @var string
      */
    protected $limited_english_proficiency_type;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->id = $data["id"];
            $this->limited_english_proficiency_descriptor_id = $data["limited_english_proficiency_descriptor_id"];
            $this->limited_english_proficiency_type = $data["limited_english_proficiency_type"];
    ...
    {
        return $this->limited_english_proficiency_descriptor_id;
    }
  
    /**
     * Sets limited_english_proficiency_descriptor_id
     * @param int $limited_english_proficiency_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setLimitedEnglishProficiencyDescriptorId($limited_english_proficiency_descriptor_id)
    {
        
        $this->limited_english_proficiency_descriptor_id = $limited_english_proficiency_descriptor_id;
        return $this;
    }
    
    /**
     * Gets limited_english_proficiency_type
     * @return string
     */
    public function getLimitedEnglishProficiencyType()
    {
        return $this->limited_english_proficiency_type;
    }
  
    /**
     * Sets limited_english_proficiency_type
     * @param string $limited_english_proficiency_type Key for LimitedEnglishProficiency
     * @return $this
     */
    public function setLimitedEnglishProficiencyType($limited_english_proficiency_type)
    {
        
        $this->limited_english_proficiency_type = $limited_english_proficiency_type;
        return $this;
    }
