...
use \ArrayAccess;
/**
 * ResponsibilityDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ResponsibilityDescriptor implements ArrayAccess
{
    /**
    ...
    static $setters = array(
        ...
        'responsibility_type' => 'setResponsibilityType',
    ...
    static $getters = array(
        ...
        'responsibility_type' => 'getResponsibilityType',
    ...
    /**
      * $responsibility_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $responsibility_descriptor_id;
    
    /**
      * $responsibility_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var string
      */
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->responsibility_descriptor_id = $data["responsibility_descriptor_id"];
            $this->responsibility_type = $data["responsibility_type"];
    ...
    {
        return $this->responsibility_descriptor_id;
    }
  
    /**
     * Sets responsibility_descriptor_id
     * @param int $responsibility_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setResponsibilityDescriptorId($responsibility_descriptor_id)
    {
        
        $this->responsibility_descriptor_id = $responsibility_descriptor_id;
        return $this;
    }
    
    /**
     * Gets responsibility_type
     * @return string
     */
    ...
    /**
     * Sets responsibility_type
     * @param string $responsibility_type A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setResponsibilityType($responsibility_type)
    {
