 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class StaffRace implements ArrayAccess
{
    /**
    ...
    /**
     * Sets race_type
     * @param string $race_type The general racial category which most clearly reflects the individual''s recognition of his or her community or with which the individual most identifies. The way this data element is listed, it must allow for multiple entries so that each individual can specify all appropriate races.        AMERICAN-INDIAN-ALASKA-NATIVE-CODE        ASIAN-CODE        BLACK-AFRICAN-AMERICAN-CODE        NATIVE-HAWAIIAN-PACIFIC-ISLANDER-CODE        WHITE-CODE
     * @return $this
     */
