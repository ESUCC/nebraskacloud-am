...
use \ArrayAccess;
/**
 * StudentCompetencyObjectiveReference Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class StudentCompetencyObjectiveReference implements ArrayAccess
{
    /**
    ...
    /**
      * $objective_education_organization_id EducationOrganization Identity Column
      * @var int
      */
    protected $objective_education_organization_id;
    ...
    /**
      * $link Represents a hyperlink to the related studentCompetencyObjective resource.
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->objective_education_organization_id = $data["objective_education_organization_id"];
    ...
    {
        return $this->objective_education_organization_id;
    }
  
    /**
     * Sets objective_education_organization_id
     * @param int $objective_education_organization_id EducationOrganization Identity Column
     * @return $this
     */
    public function setObjectiveEducationOrganizationId($objective_education_organization_id)
    {
        
        $this->objective_education_organization_id = $objective_education_organization_id;
        return $this;
    }
    ...
    /**
     * Sets link
     * @param \Swagger\Client\Model\Link $link Represents a hyperlink to the related studentCompetencyObjective resource.
     * @return $this
     */
