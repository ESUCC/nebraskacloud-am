...
use \ArrayAccess;
/**
 * AccommodationType Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class AccommodationType implements ArrayAccess
{
    /**
    ...
    static $setters = array(
        '_etag' => 'setEtag',
        'accommodation_type_id' => 'setAccommodationTypeId',
    ...
    static $getters = array(
        '_etag' => 'getEtag',
        'accommodation_type_id' => 'getAccommodationTypeId',
    ...
    /**
      * $accommodation_type_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $accommodation_type_id;
    ...
    /**
     * Sets accommodation_type_id
     * @param int $accommodation_type_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setAccommodationTypeId($accommodation_type_id)
    {
