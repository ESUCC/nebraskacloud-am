...
use \ArrayAccess;
/**
 * ProgramAssignmentDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ProgramAssignmentDescriptor implements ArrayAccess
{
    /**
    ...
    static $swaggerTypes = array(
        ...
        'program_assignment_type' => 'string',
    ...
    static $attributeMap = array(
        ...
        'program_assignment_type' => 'programAssignmentType',
    ...
    static $setters = array(
        ...
        'program_assignment_type' => 'setProgramAssignmentType',
    ...
    static $getters = array(
        ...
        'program_assignment_type' => 'getProgramAssignmentType',
    ...
    /**
      * $program_assignment_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $program_assignment_descriptor_id;
    
    /**
      * $program_assignment_type Key for ProgramAssignment
      * @var string
      */
    protected $program_assignment_type;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->program_assignment_descriptor_id = $data["program_assignment_descriptor_id"];
            $this->program_assignment_type = $data["program_assignment_type"];
    ...
    {
        return $this->program_assignment_descriptor_id;
    }
  
    /**
     * Sets program_assignment_descriptor_id
     * @param int $program_assignment_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setProgramAssignmentDescriptorId($program_assignment_descriptor_id)
    {
        
        $this->program_assignment_descriptor_id = $program_assignment_descriptor_id;
        return $this;
    }
    
    /**
     * Gets program_assignment_type
     * @return string
     */
    public function getProgramAssignmentType()
    {
        return $this->program_assignment_type;
    }
  
    /**
     * Sets program_assignment_type
     * @param string $program_assignment_type Key for ProgramAssignment
     * @return $this
     */
    public function setProgramAssignmentType($program_assignment_type)
    {
        
        $this->program_assignment_type = $program_assignment_type;
        return $this;
    }
