...
use \ArrayAccess;
/**
 * CourseCompetencyLevel Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CourseCompetencyLevel implements ArrayAccess
{
    /**
    ...
    /**
      * $competency_level_descriptor The ID of the Competency Level Descriptor
      * @var string
      */
     ...
     * @param string $competency_level_descriptor The ID of the Competency Level Descriptor
     * @return $this
     */
