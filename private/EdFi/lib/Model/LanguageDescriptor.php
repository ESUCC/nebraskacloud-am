...
use \ArrayAccess;
/**
 * LanguageDescriptor Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LanguageDescriptor implements ArrayAccess
{
    /**
    ...
    /**
      * $language_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
      * @var int
      */
    protected $language_descriptor_id;
    
    /**
      * $language_type Language(s) the individual uses to communicate
      * @var string
      */
    protected $language_type;
    ...
    public function __construct(array $data = null)
    {
        ...
        if ($data != null) {
            ...
            $this->id = $data["id"];
            $this->language_descriptor_id = $data["language_descriptor_id"];
    ...
    {
        return $this->language_descriptor_id;
    }
  
    /**
     * Sets language_descriptor_id
     * @param int $language_descriptor_id A unique identifier used as Primary Key, not derived from business logic, when acting as Foreign Key, references the parent table.
     * @return $this
     */
    public function setLanguageDescriptorId($language_descriptor_id)
    {
        
        $this->language_descriptor_id = $language_descriptor_id;
        return $this;
    }
    ...
    /**
     * Sets language_type
     * @param string $language_type Language(s) the individual uses to communicate
     * @return $this
     */
