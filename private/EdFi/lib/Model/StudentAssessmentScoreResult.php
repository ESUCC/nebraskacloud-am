...
use \ArrayAccess;
/**
 * StudentAssessmentScoreResult Class Doc Comment
 *
 * @category    Class
 * @description 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class StudentAssessmentScoreResult implements ArrayAccess
{
    /**
    ...
    /**
      * $assessment_reporting_method_type The name of the analytic score.  For example:  Percentile  Quantile measure  Lexile measure  Vertical scale score  TPM score  ...  ...
      * @var string
      */
    protected $assessment_reporting_method_type;
    
    /**
      * $result A meaningful raw score or statistical expression of the performance of an individual. The results can be expressed as a number, percentile, range, level, etc.
      * @var string
      */
    protected $result;
     ...
     * @param string $assessment_reporting_method_type The name of the analytic score.  For example:  Percentile  Quantile measure  Lexile measure  Vertical scale score  TPM score  ...  ...
     * @return $this
     */
    ...
    /**
     * Sets result
     * @param string $result A meaningful raw score or statistical expression of the performance of an individual. The results can be expressed as a number, percentile, range, level, etc.
     * @return $this
     */
