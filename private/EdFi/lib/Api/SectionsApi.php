...
class SectionsApi
{
    ...
    {
        list($response, $statusCode, $httpHeader) = $this->deleteSectionByIdWithHttpInfo ($id, $if_match);
        return $response; 
    }


    /**
     * deleteSectionByIdWithHttpInfo
     *
     * Deletes an existing resource using the resource identifier.
     *
     * @param string $id A resource identifier specifying the resource to be deleted. (required)
    ...
    public function deleteSectionByIdWithHttpInfo($id, $if_match = null)
    {
        ...
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling deleteSectionById');
        }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSectionByKey($school_id, $class_period_name, $classroom_identification_code, $local_course_code, $term_descriptor, $school_year, $unique_section_code, $sequence_of_course, $if_none_match = null)
    {
        list($response, $statusCode, $httpHeader) = $this->getSectionByKeyWithHttpInfo ($school_id, $class_period_name, $classroom_identification_code, $local_course_code, $term_descriptor, $school_year, $unique_section_code, $sequence_of_course, $if_none_match);
        return $response; 
    }


    /**
     * getSectionByKeyWithHttpInfo
     *
     * Retrieves a specific resource using the values of the resource's natural key (using the \"Get By Key\" pattern).
     *
     * @param int $school_id School Identity Column (required)
     ...
     * @param int $sequence_of_course When a Section is part of a sequence of parts for a course, the number if the sequence. If the course has only one part, the value of this Section attribute should be 1. (required)
     * @param string $if_none_match The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)
     * @return Array of \Swagger\Client\Model\Section, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSectionByKeyWithHttpInfo($school_id, $class_period_name, $classroom_identification_code, $local_course_code, $term_descriptor, $school_year, $unique_section_code, $sequence_of_course, $if_none_match = null)
    {
        
        // verify the required parameter 'school_id' is set
        if ($school_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $school_id when calling getSectionByKey');
        }
        // verify the required parameter 'class_period_name' is set
        if ($class_period_name === null) {
            throw new \InvalidArgumentException('Missing the required parameter $class_period_name when calling getSectionByKey');
        }
        // verify the required parameter 'classroom_identification_code' is set
        if ($classroom_identification_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $classroom_identification_code when calling getSectionByKey');
        }
        // verify the required parameter 'local_course_code' is set
        if ($local_course_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $local_course_code when calling getSectionByKey');
        }
        // verify the required parameter 'term_descriptor' is set
        if ($term_descriptor === null) {
            throw new \InvalidArgumentException('Missing the required parameter $term_descriptor when calling getSectionByKey');
        }
        // verify the required parameter 'school_year' is set
        if ($school_year === null) {
            throw new \InvalidArgumentException('Missing the required parameter $school_year when calling getSectionByKey');
        }
        // verify the required parameter 'unique_section_code' is set
        if ($unique_section_code === null) {
            throw new \InvalidArgumentException('Missing the required parameter $unique_section_code when calling getSectionByKey');
        }
        // verify the required parameter 'sequence_of_course' is set
        if ($sequence_of_course === null) {
            throw new \InvalidArgumentException('Missing the required parameter $sequence_of_course when calling getSectionByKey');
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, 'GET',
                $queryParams, $httpBody,
                $headerParams, '\Swagger\Client\Model\Section'
            );
            ...
            return array(\Swagger\Client\ObjectSerializer::deserialize($response, '\Swagger\Client\Model\Section', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = \Swagger\Client\ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\Section', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            case 500:
                $data = \Swagger\Client\ObjectSerializer::deserialize($e->getResponseBody(), '\Swagger\Client\Model\WebServiceError', $e->getResponseHeaders());
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSectionsById($id, $if_none_match = null)
    {
        list($response, $statusCode, $httpHeader) = $this->getSectionsByIdWithHttpInfo ($id, $if_none_match);
        return $response; 
    }


    /**
     * getSectionsByIdWithHttpInfo
     *
     * Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
     *
     * @param string $id A resource identifier specifying the resource to be retrieved. (required)
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getSectionsByIdWithHttpInfo($id, $if_none_match = null)
    {
        
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling getSectionsById');
        }
     ...
     *
     * @param \Swagger\Client\Model\Section $section The JSON representation of the \&quot;section\&quot; resource to be created or updated. (required)
     * @return void
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function postSections($section)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function postSectionsWithHttpInfo($section)
    {
        
        // verify the required parameter 'section' is set
        if ($section === null) {
            throw new \InvalidArgumentException('Missing the required parameter $section when calling postSections');
        }
     ...
     * @param \Swagger\Client\Model\Section $section The JSON representation of the \&quot;section\&quot; resource to be updated. (required)
     * @param string $if_match The ETag header value used to prevent the PUT from updating a resource modified by another consumer. (optional)
     * @return void
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function putSection($id, $section, $if_match = null)
    {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function putSectionWithHttpInfo($id, $section, $if_match = null)
    {
        
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling putSection');
        }
        // verify the required parameter 'section' is set
        if ($section === null) {
            throw new \InvalidArgumentException('Missing the required parameter $section when calling putSection');
        }
