...
/**
 * CharterStatusTypesApi Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
...
class CharterStatusTypesApi
{
    ...
    /**
     * deleteCharterStatusTypeByIdWithHttpInfo
     *
     * Deletes an existing resource using the resource identifier.
     *
     * @param string $id A resource identifier specifying the resource to be deleted. (required)
     ...
     *
     * @param int $charter_status_type_id Key for CharterStatus (required)
     ...
     * @return \Swagger\Client\Model\CharterStatusType
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    ...
    /**
     * getCharterStatusTypeByKeyWithHttpInfo
     *
     * Retrieves a specific resource using the values of the resource's natural key (using the \"Get By Key\" pattern).
     *
     * @param int $charter_status_type_id Key for CharterStatus (required)
     * @param string $if_none_match The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource. (optional)
     * @return Array of \Swagger\Client\Model\CharterStatusType, HTTP status code, HTTP response headers (array of strings)
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    ...
    /**
     * getCharterStatusTypesByIdWithHttpInfo
     *
     * Retrieves a specific resource using the resource's identifier (using the \"Get By Id\" pattern).
     *
     * @param string $id A resource identifier specifying the resource to be retrieved. (required)
     ...
     *
     * @param \Swagger\Client\Model\CharterStatusType $charter_status_type The JSON representation of the \&quot;charterStatusType\&quot; resource to be created or updated. (required)
     * @return void
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    ...
    /**
     * postCharterStatusTypesWithHttpInfo
     *
     * Creates or updates resources based on the natural key values of the supplied resource.
     *
     * @param \Swagger\Client\Model\CharterStatusType $charter_status_type The JSON representation of the \&quot;charterStatusType\&quot; resource to be created or updated. (required)
     ...
     * @param \Swagger\Client\Model\CharterStatusType $charter_status_type The JSON representation of the \&quot;charterStatusType\&quot; resource to be updated. (required)
    ...
    /**
     * putCharterStatusTypeWithHttpInfo
     *
     * Updates an existing resource based on the resource identifier.
     *
     * @param string $id A resource identifier specifying the resource to be updated. (required)
